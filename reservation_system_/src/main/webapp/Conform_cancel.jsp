...
<body>
    ...
    hs.setAttribute("pnr", pnr);
    EntityManagerFactory emf = Persistence.createEntityManagerFactory("desto");
	EntityManager em = emf.createEntityManager();
	EntityTransaction et = em.getTransaction();
	
	Query q=em.createQuery("select a from Details a where a.PNR_=?1");
	q.setParameter(1, pnr);
    ...
    <div class="container">
        ...
        <tr>
            ...
            <td><%=d.getDate() %></td>
            <td><%=d.getPNR_() %></td>
            <td><button value="submit"><a href="c.jsp">Conform Cancel</a></button></td>
        </tr> 
    </table>
    <%} 
    }
